...
const skillGroups = [
  {
    ...
    skills: ['Agentic AI', 'Amazon Bedrock', 'RAG', 'Prompt Engineering', 'LLMs', 'Conversational AI', 'Fine-Tuning', 'AI Agents'],
  },
  {
    title: 'Languages',
  ...
  {
    title: 'Frontend',
    color: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900 dark:text-cyan-200 hover:bg-cyan-200 dark:hover:bg-cyan-800',
  ...
  {
    title: 'Cloud & AWS',
    color: 'bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-200 hover:bg-orange-200 dark:hover:bg-orange-800',
    header: 'text-orange-700 dark:text-orange-400',
    skills: ['AWS Lambda', 'Amazon S3', 'Amazon EC2', 'API Gateway', 'DynamoDB', 'Amazon Bedrock', 'Cognito', 'AWS Amplify', 'SageMaker', 'Amazon Lex', 'CloudWatch', 'IAM', 'VPC', 'Route 53'],
  },
  {
    title: 'Data Science',
    color: 'bg-pink-100 text-pink-700 dark:bg-pink-900 dark:text-pink-200 hover:bg-pink-200 dark:hover:bg-pink-800',
    header: 'text-pink-700 dark:text-pink-400',
    skills: ['Machine Learning', 'Data Analysis', 'Pandas', 'NumPy', 'Scikit-learn', 'Matplotlib', 'Seaborn', 'Power BI'],
  },
  {
  ...
  {
    title: 'Soft Skills',
    color: 'bg-teal-100 text-teal-700 dark:bg-teal-900 dark:text-teal-200 hover:bg-teal-200 dark:hover:bg-teal-800',
    header: 'text-teal-700 dark:text-teal-400',
    skills: ['Effective Communication', 'Public Speaking', 'Team Lead', 'Problem Solving', 'Time Management', 'Interpersonal Skills'],
  },
];
    ...
    <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground text-base max-w-2xl mx-auto">
          Technologies I work with to build production-ready AI and software applications.
        </p>
      </div>
